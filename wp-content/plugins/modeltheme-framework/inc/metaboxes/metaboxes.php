    ...
    $fa_list = array(
      ...
      */
            ...
            'fields'     => array(
                  ...
                  */
                  ...
                  array(
                        ...
                        'desc'    => __( 'Set the background color of the Page Preloader for this page only(Default: #E56768)', 'modeltheme' ),
      ...
      $meta_boxes['listings_metaboxs'] = array(
            ...
            'title'      => __( 'MT Clinic Locations Custom Options', 'mtlisitings' ),
            ...
            'fields'     => array(
                  ...
                  array(
                        'name' => '<h1>General</h1>',
                        'desc' => 'Details Listed into the General Group',
                        'type' => 'title',
                        'id'   => 'mtlistings_general_group'
                  ),              
                  array(
                        'name'    => __( 'Phone number', 'mtlisitings' ),
                        'desc'    => __( 'Set phone number', 'mtlisitings' ),
                        'id'      => 'mt_listing_phone_number',
                        'type'    => 'text_medium',
                        'default' => ''
                  ),
                  array(
                        'name'    => __( 'Mail Address', 'mtlisitings' ),
                        'desc'    => __( 'Set mail address', 'mtlisitings' ),
                        'id'      => 'mt_listing_mail_address',
                        'type'    => 'text_medium',
                        'default' => ''
                  ),
                  array(
                        'name'    => __( 'Location address', 'mtlisitings' ),
                        'desc'    => __( 'e.g Brailei Street, nr. 201', 'mtlisitings' ),
                        'id'      => 'mt_listing_location_address',
                        'type'    => 'text_small',
                        'default' => ''
                  )
            ),
