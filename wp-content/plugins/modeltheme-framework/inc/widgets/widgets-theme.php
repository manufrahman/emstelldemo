...
class address_social_icons extends WP_Widget {
    ...
    function __construct() {
        parent::__construct('address_social_icons', esc_html__('Clinika - Contact + Social links', 'modeltheme'),array( 'description' => esc_html__( 'Clinika - Contact information + Social icons', 'modeltheme' ), ) );
    }
        ...
        <div class="sidebar-social-networks address-social-links">
            ...
            <?php if('on' == $instance['widget_contact_details']) { ?>
                <div class="contact-details">
                    <p><i class="fa fa-home"></i> <?php echo wp_kses_post($clinika_redux['clinika_contact_address']); ?></p>
                    <p><i class="fa fa-phone-square"></i> <?php echo wp_kses_post($clinika_redux['clinika_contact_phone']); ?></p>
                    <p><i class="fa fa-envelope-square"></i> <?php echo wp_kses_post($clinika_redux['clinika_contact_email']); ?></p>
                </div>
            <?php } ?>


            <?php if('on' == $instance['widget_social_icons']) { ?>
                <h3 class="follow_us widget-title"><?php echo esc_html__('Follow Us: ', 'modeltheme'); ?></h3>
...
/* ========= clinika_Recent_Posts_Widget ===================================== */
class recent_entries_with_thumbnail extends WP_Widget {

    function __construct() {
        parent::__construct('recent_entries_with_thumbnail', esc_html__('Clinika - Recent Posts with thumbnails', 'modeltheme'),array( 'description' => esc_html__( 'Clinika - Recent Posts with thumbnails', 'modeltheme' ), ) );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        foreach ($recentposts as $post) {
            $thumbnail_src = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ),'clinika_post_widget_pic150x120' );
...
class post_thumbnails_slider extends WP_Widget {
    ...
    function __construct() {
        parent::__construct('post_thumbnails_slider', esc_html__('Clinika - Post thumbnails slider', 'modeltheme'),array( 'description' => esc_html__( 'Clinika - Post thumbnails slider', 'modeltheme' ), ) );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        $myContent .= '<div class="slider_holder relative">';
            ...
            foreach ($recentposts as $post) {
                $thumbnail_src = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ),'clinika_post_pic700x450' );
...
class social_share extends WP_Widget {
    ...
    function __construct() {
        parent::__construct('social_share', esc_html__('Clinika - Social Share Icons', 'modeltheme'),array( 'description' => esc_html__( 'Clinika - Social Share Icons', 'modeltheme' ), ) );
    }
        ...
        <div class="sidebar-share-social-links">
            ...
            <ul class="share-social-links">
                ...
                <li class="pinterest">
                    ...
                    <?php /*<a href="http://pinterest.com/pin/create/button/?url=<?php echo wp_kses_post($siteurl); ?>&amp;media=<?php echo wp_kses_post($clinika_redux['clinika_logo']['url']); ?>&amp;description=<?php echo wp_kses_post($sitedescription); ?>" target="_blank"><i class="fa fa-pinterest"></i></a>*/ ?>
                </li>
...
// Register Widgets
function clinika_register_widgets() {
...
add_action( 'widgets_init', 'clinika_register_widgets' );