    ...
    function wbc_extended_example( $demo_active_import , $demo_directory_path ) {
        ...
        */
        ...
        if ( class_exists( 'RevSlider' ) ) {
            $wbc_sliders_array = array(
                'Main Home' => array(),
                'Home Video' => array(),
                'Surgical Masks Shop' => array(),
                'Hand Sanitizers Shop' => array('medical-products.zip'),
                'Thermometers Shop' => array(),
                'Marijuana Clinic Shop' => array(),
                'Veterinarian Clinic' => array('veterinarian-slider.zip'),
                'Addictions Clinic' => array('addiction-rehab.zip'),
                'Covid 19 Vaccination Center' => array('medicare-header1.zip', 'medicare-research1.zip'),
                'Online Pharmacy' => array(), 
                'Skin Care' => array('skin-care.zip','medicare-research-skin-care.zip'),
                'Blood Donation Clinic' => array(),  
            );
        ...
        */
        ...
        $wbc_home_pages = array(
            ...
            'Surgical Masks Shop' => 'Surgical Masks Shop',
            'Hand Sanitizers Shop' => 'Hand Sanitizers Shop',
            'Thermometers Shop' => 'Thermometers Shop',
            'Marijuana Clinic Shop' => 'Marijuana Clinic',
            'Veterinarian Clinic' => 'Main Home',
            'Addictions Clinic' => 'Addiction Rehab Clinic',
            'Covid 19 Vaccination Center' => 'Covid-19 Vaccination Center',
            'Online Pharmacy' => 'Online Pharmacy Shop',
            'Skin Care' => 'Skin Care',
            'Blood Donation Clinic' => 'Blood Donation Home',
