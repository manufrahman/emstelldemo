...
*/
function clinika_testimonial_custom_post() {
...
add_action('init', 'clinika_testimonial_custom_post');
...
*/
function clinika_services_custom_post() {
...
add_action('init', 'clinika_services_custom_post');
...
*/
function clinika_services_taxonomy() {
...
add_action( 'init', 'clinika_services_taxonomy' );
...
*/
function clinika_members_custom_post() {
...
add_action('init', 'clinika_members_custom_post');
...
function mtlisitings_listings_custom_post() {
    register_post_type('mt_listing', array(
                        'label' => __('Clinic Locations','modeltheme'),
                        'description' => '',
                        'public' => true,
                        'show_ui' => true,
                        'show_in_menu' => true,
                        ...
                        'map_meta_cap' => true,
                        'hierarchical' => false,
                        'rewrite' => array('slug' => 'clinic-locations', 'with_front' => true),
                        'query_var' => true,
                        'menu_position' => '1',
                        'menu_icon' => 'dashicons-performance',
                        'supports' => array('title','editor','thumbnail','author','excerpt', 'comments'),
                        'labels' => array (
                            'name' => __('Clinic Locations','modeltheme'),
                            'singular_name' => __('Clinic Location','modeltheme'),
                            'menu_name' => __('MT Clinic Locations','modeltheme'),
                            'add_new' => __('Add Clinic Location','modeltheme'),
                            'add_new_item' => __('Add New Clinic Location','modeltheme'),
                            'edit' => __('Edit','modeltheme'),
                            'edit_item' => __('Edit Clinic Location','modeltheme'),
                            'new_item' => __('New Clinic Location','modeltheme'),
                            'view' => __('View Clinic Location','modeltheme'),
                            'view_item' => __('View Clinic Location','modeltheme'),
                            'search_items' => __('Search Clinic Locations','modeltheme'),
                            'not_found' => __('No Clinic Locations Found','modeltheme'),
                            'not_found_in_trash' => __('No Clinic Locations Found in Trash','modeltheme'),
                            'parent' => __('Parent Clinic Location','modeltheme'),
                            )
                        ) 
                    ); 
}
...
function mtlisitings_listings_category2_custom_post() {
    ...
    $labels = array(
        ...
        'singular_name'              => _x( 'Categories', 'Taxonomy Singular Name', 'modeltheme' ),
        'menu_name'                  => __( 'Categories', 'modeltheme' ),
        'all_items'                  => __( 'All Items', 'modeltheme' ),
        'parent_item'                => __( 'Parent Item', 'modeltheme' ),
        'parent_item_colon'          => __( 'Parent Item:', 'modeltheme' ),
        'new_item_name'              => __( 'New Item Name', 'modeltheme' ),
    ...
    $args = array(
        ...
        'show_in_nav_menus'          => true,
        'show_tagcloud'              => true,
        'rewrite'                    => array( 'slug' => 'clinic-categories' ),
    );
