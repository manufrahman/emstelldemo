...
add_action('init','clinika_vc_shortcodes');   
function clinika_vc_shortcodes(){
...
#SHORTCODE: Services Activities shortcode
  ...
  #SHORTCODE: Progress bars shortcode
    vc_map( 
        ...
        "base" => "progress_bar",
        "category" => esc_attr__('Clinika Theme', 'modeltheme', 'modeltheme'),
...
// clinika - Pricing table
    vc_map( 
      array(
       "name" => esc_attr__("clinika - Pricing table", "modeltheme"),
       "base" => "pricing-table-v2",
       "category" => esc_attr__("clinika", "modeltheme"),
        "icon" => plugins_url( 'images/pricing-table.svg', __FILE__ ),
       "params" => array(
          array(
             "type" => "textfield",
  ...
  vc_map( array(
     ...
     "params" => array(
         array(
            ...
            "heading" => esc_attr__( "Heading", 'modeltheme' ),
            "param_name" => "heading",
            "value" => esc_attr__( "Clinika Is The Ultimate WordPress Multi-Purpose WordPress Theme!", 'modeltheme' ),
            "description" => esc_attr__( "" )
         ),
        array(
           "type" => "dropdown",
  ...
  $product_category = array();
        ...
        // Clinika - Products by Category v2
        vc_map( 
          array(
  ...
  //   ));
     ...
     "params" => array(
      ...
      vc_map( array(
       ...
       "params" => array(
        ...
        vc_map( array(
           "name" => __("Row Separator", 'modeltheme'),
           ...
           "params" => array(
              array(
                  "type" => "colorpicker",
                  "class" => "",
                  "heading" => esc_attr__( "Row Separator Background", 'modeltheme' ),
                  "param_name" => "bg_color",
                  "value" => '#FFBA41', //Default color #FFBA41
                  "description" => esc_attr__( "Set the background color of the Row Separator", 'modeltheme' )
               ),
                array(
                  "type"         => "dropdown",
                  "holder"       => "div",
                  ...
                  "heading"      => esc_attr__("Clouds Position", 'modeltheme'),
                  "value"        => array(
                    esc_attr__('Choose an Option', 'modeltheme')    => '',
                    esc_attr__('Top Left', 'modeltheme')    => 'top-left',
                    esc_attr__('Top Right', 'modeltheme') => 'top-right',
                    esc_attr__('Bottom Left', 'modeltheme')    => 'bottom-left',
                    esc_attr__('Bottom Right', 'modeltheme') => 'bottom-right',
                )
              ),
              array(
                  'type' => 'css_editor',
    ...
    */
    ...
    // Shortcode Blood Request
    vc_map( array(
        "name" => esc_attr__("Blood Requests", 'modeltheme'),
        "category" => esc_attr__('Clinika Theme', 'modeltheme'),
        "icon" => plugins_url( 'images/clients.svg', __FILE__ ),
        "base" => "mt_blood_single_request_short",
        "as_parent" => array('only' => 'mt_blood_single_request_short_item'), 
    ...
    vc_map( array(
        "name" => esc_attr__("Single Request", 'modeltheme'),
        "base" => "mt_blood_single_request_short_item",
        "content_element" => true,
        "as_child" => array('only' => 'mt_blood_single_request_short'),
        "params" => array(
             array(
                 "group" => "Options",
                 "type" => "attach_image",
                 "class" => "",
                 "heading" => esc_attr__("Image", 'modeltheme'),
            ...
            array(
              ...
              "type" => "textfield",
              "class" => "",
              "heading" => esc_attr__("Blood Group", 'modeltheme'),
            ...
            array(
              ...
              "type" => "textfield",
              "class" => "",
              "heading" => esc_attr__("Blood Unit", 'modeltheme'),
              "param_name" => "banner_unit"
            ),
            array(
              "group" => "Options",
              "type" => "textfield",
              "class" => "",
              "heading" => esc_attr__("When Needed", 'modeltheme'),
              "param_name" => "banner_when"
            ),
            array(
              "group" => "Options",
              "type" => "textfield",
              "class" => "",
              "heading" => esc_attr__("Nr Lot", 'modeltheme'),
              "param_name" => "banner_nr"
            ),
            array(
               "group" => "Styling",
               "type" => "colorpicker",
    ...
    if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
        class WPBakeryShortCode_mt_blood_single_request_short extends WPBakeryShortCodesContainer {
        }
    }
    if ( class_exists( 'WPBakeryShortCode' ) ) {
        class WPBakeryShortCode_mt_blood_single_request_short_item extends WPBakeryShortCode {
        }
    }
