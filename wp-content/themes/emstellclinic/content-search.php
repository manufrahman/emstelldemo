 ...
 *
 */
$thumbnail_src = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'clinika_related_post_pic500x300' );
?>
<article id="post-<?php the_ID(); ?>" <?php post_class('row single-post'); ?>>
    ...
    <div class="col-md-8 post-details">
        ...
        <div class="post-category-comment-date row">
            <span class="post-author"><?php echo esc_html__('by ', 'clinika') . get_the_author(); ?></span>   /   
            <span class="post-comments"><a href="<?php the_permalink(); ?>"><?php comments_number( esc_html__('No Comments', 'clinika'), esc_html__('1 Comment', 'clinika'), esc_html__('% Comments', 'clinika') ); ?></a></span>   /   
        ...
        <?php
            ...
            the_content( sprintf(
                esc_html__( 'Continue reading ', 'clinika' ) . '%s <span class="meta-nav">&rarr;</span>',
