jQuery(document).ready(function(){
  ...
  var header_custom = jQuery('#clinika_custom_header_options_status').val();
  if (header_custom == "no" ){
    jQuery(".cmb_id_clinika_header_custom_fixed_navigation").hide();
    jQuery(".cmb_id_clinika_header_custom_logo").hide();
    jQuery(".cmb_id_clinika_header_custom_variant").hide();
  }
  jQuery('#clinika_custom_header_options_status').on('change', function() {
    ...
    if (header_custom == "no" ){
      ...
      jQuery(".cmb_id_clinika_header_custom_fixed_navigation").show();
      jQuery(".cmb_id_clinika_header_custom_logo").show();
      jQuery(".cmb_id_clinika_header_custom_variant").show();
    }
  });
  ...
  var course_layout = jQuery('#clinika_course_layout').val();
  var course_sidebar = jQuery('.cmb_id_clinika_course_sidebar');
  ...
  jQuery('#clinika_course_layout').on('change', function() {
    var course_layout = jQuery('#clinika_course_layout').val();
    var course_sidebar = jQuery('.cmb_id_clinika_course_sidebar');
