...
<div class="yith-wcwl-add-to-wishlist add-to-wishlist-<?php echo esc_attr($product_id); ?>">
    ...
    <div class="yith-wcwl-wishlistaddedbrowse hide" style="display:none;">
        <a href="<?php echo esc_url( $wishlist_url )?>" data-toggle="tooltip" data-tooltip="<?php echo esc_attr__('Add to Wishlist Wishlist', 'clinika'); ?>" data-placement="top" title="<?php echo esc_attr__('Browse Wishlist', 'clinika'); ?>">
    ...
    <div class="yith-wcwl-wishlistexistsbrowse <?php echo esc_attr( $exists && ! $available_multi_wishlist ) ? 'show' : 'hide' ?>" style="display:<?php echo esc_attr( $exists && ! $available_multi_wishlist ) ? 'block' : 'none' ?>">
        <a href="<?php echo esc_url( $wishlist_url ) ?>" data-tooltip="<?php echo esc_attr__('Check Wishlist', 'clinika'); ?>" class="button">
