    ...
    <div class="<?php echo esc_html($header_container); ?>">
      <div class="row">
        ...
        <div class="top-links col-md-3">
          ...
          <?php } ?>
          <?php if (class_exists('WooCommerce')) { ?>
            <span class="top-cart"><a  class="shop_cart" href="<?php echo esc_url($cart_url); ?>"><i class="fa fa-shopping-cart"></i></a></span>
            <!-- Shop Minicart -->
          ...
          <p class="header-button">
            <a href="<?php echo esc_url(clinika_redux('clinika_header_booking')); ?>"><?php esc_html_e('Appointment','clinika'); ?></a>
          </p>
        </div>
      </div>
    </div>
